local CLIENT = "atlas.providers.gitea.forgejo.client"
local COMMENTS = "atlas.pulls.providers.gitea.forgejo.api.comments"
local PIPELINES = "atlas.pulls.providers.gitea.forgejo.api.pipelines"
local PROVIDER = "atlas.pulls.providers.gitea.forgejo"
local REVIEWS = "atlas.pulls.providers.gitea.forgejo.api.reviews"
local PREFIX = "atlas.pulls.providers.gitea.forgejo"
...
describe("Forgejo pulls", function()
	...
	it("wires the Forgejo implementation", function()
		...
		assert.equal(require("atlas.pulls.providers.gitea.forgejo.actions"), provider.capabilities.actions)
		assert.equal(
			require("atlas.pulls.providers.gitea.forgejo.actions.pipelines"),
