...
---@param handlers { gh: function|nil, api: function|nil, delete_mem: function|nil, hostname: function|nil } stubs for the client entry points
function M.install(handlers)
	handlers = handlers or {}
	package.loaded[MODULE] = nil
	package.preload[MODULE] = function()
		return {
			hostname = handlers.hostname or function()
				return "github.com"
			end,
