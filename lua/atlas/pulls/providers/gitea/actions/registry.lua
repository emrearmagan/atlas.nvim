...
local repositories = require("atlas.pulls.providers.gitea.api.repositories")
local search = require("atlas.pulls.providers.gitea.completion.search")
...
---@param ctx AtlasPullActionContext
---@param on_done fun(details: GiteaPullRequestDetails|nil, err: string|nil)
---@return { cancel: fun() }|nil
local function with_details(ctx, on_done)
	if ctx.details then
		local details = ctx.details
		---@cast details GiteaPullRequestDetails
		on_done(details, nil)
		return nil
	end
