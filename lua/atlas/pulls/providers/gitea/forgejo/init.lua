...
local checks_api = require("atlas.pulls.providers.gitea.forgejo.api.checks")
local comments_api = require("atlas.pulls.providers.gitea.forgejo.api.comments")
local commits_api = require("atlas.pulls.providers.gitea.forgejo.api.commits")
local files_api = require("atlas.pulls.providers.gitea.forgejo.api.files")
local notifications_api = require("atlas.pulls.providers.gitea.forgejo.api.notifications")
local pipelines_api = require("atlas.pulls.providers.gitea.forgejo.api.pipelines")
local pullrequests_api = require("atlas.pulls.providers.gitea.forgejo.api.pullrequests")
...
local actions = require("atlas.pulls.providers.gitea.forgejo.actions")
...
return {
	...
	capabilities = {
		...
		pipelines = {
			...
			actions = require("atlas.pulls.providers.gitea.forgejo.actions.pipelines"),
		},
