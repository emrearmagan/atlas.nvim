...
function M.to_pull_request(raw, workspace, repo)
	...
	local destination_repo_full_name = tostring(destination_repository.full_name or repo_full_name)
	local source_is_fork = source_repo_full_name ~= "" and source_repo_full_name ~= destination_repo_full_name
