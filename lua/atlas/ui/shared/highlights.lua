...
local groups = {
	...
	AtlasTextPositive = { link = "DiagnosticOk" },
	AtlasTextNote = { fg = "#f5bde6", bold = true },
	AtlasTextWarning = { fg = "#f9e2af", bold = true },

	AtlasLogInfo = { link = "DiagnosticInfo" },
	AtlasLogWarn = { link = "DiagnosticWarn" },
	AtlasLogError = { link = "DiagnosticError" },
	AtlasLogErrorLine = { link = "DiagnosticVirtualTextError" },
