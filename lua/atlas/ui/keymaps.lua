...
function M.register(buf)
	...
	utils.insert_if(items, item("ui.next_item", {
		desc = "Next item",
		hidden = true,
		callback = function()
	...
	utils.insert_if(items, item("ui.previous_item", {
		desc = "Previous item",
		hidden = true,
		callback = function()
	...
	utils.insert_if(items, item("ui.first_item", {
	...
	utils.insert_if(items, item("ui.last_item", {
