local clients = require("atlas.providers.forgejo.client")
...
---@param service table
---@return table
local function new(service)
	local api = {}

	---Fetch a paginated Forgejo list. The API stops returning values after
	...
	---@return { cancel: fun() }
	function api.fetch_all(endpoint, params, opts, on_done)
		opts = opts or {}
...
M.pulls = new(clients.pulls)
M.issues = new(clients.issues)
